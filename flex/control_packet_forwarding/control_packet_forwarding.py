...
class ControlPacketForwarding(Module):
    ...
    def start(self):
        ...
        network.register_handler(PacketHeader.CONTROLFROMSWITCH, Control_From_Switch_Handler(self))
        network.register_handler(PacketHeader.REGEDITCONCERNS, Register_Concerns_Handler(self))
